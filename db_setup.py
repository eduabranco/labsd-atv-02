...
def save_config(
    ...
    # Build config dictionary programmatically to avoid string formatting issues
    config_lines = [
        "# Database Configuration (Auto-generated by db_setup.py)",
    ...
    if socket_path:
        # Add comma to previous line and append socket path
        config_lines[-1] += ','
        config_lines.append(f'    "unix_socket": "{socket_path}"')
